...
- **Upgrade tonic to 0.12 ([#571](https://github.com/matze/console/pull/571))** ([5f6faa2](https://github.com/tokio-rs/console/commit/5f6faa22d944735c2b8c312cac03b35a4ab228ef))<br />This is a breaking change for users of `console-api` and
...
- Add `TOKIO_CONSOLE_BUFFER_CAPACITY`  env variable ([#568](https://github.com/matze/console/pull/568)) ([a6cf14b](https://github.com/tokio-rs/console/commit/a6cf14b370275367dcecf1191e60f0bd260250d8))

### Updated

- [**breaking**](#0.4.0-breaking) Upgrade tonic to 0.12 ([#571](https://github.com/matze/console/pull/571)) ([5f6faa2](https://github.com/tokio-rs/console/commit/5f6faa22d944735c2b8c312cac03b35a4ab228ef))
